<template>
  <div class="art-chart_bar2">
    <div class="art-chart_bar2-canvas"></div>
  </div>
</template>
					    ...
					    series: [
						    {
							    ...
							    barCategoryGap: '0%',
							    symbol: 'path://M74.895,154.844 L75.800,154.844 C75.800,154.844 75.470,155.014 74.895,154.844 ZM40.500,154.844 L5.969,154.844 C8.303,154.167 15.484,147.055 20.992,87.660 C20.992,87.660 31.210,2.000 40.500,2.000 C49.789,2.000 60.008,87.660 60.008,87.660 C64.963,146.613 72.345,154.089 74.895,154.844 L40.500,154.844 ZM5.200,154.844 L5.969,154.844 C5.477,154.986 5.200,154.844 5.200,154.844 z',
							    symbolSize: ["100%","100%"],
							    symbolClip: true,
							    ...
							    tooltip: {
								    ...
								    formatter: function (params, ticket, callback) {
									    let str = '<div class="art-chart_bar2-tooltip"><p>占比 ' + params.data + '%</p></div>';
									    return str
								    }
							    }
						    }
