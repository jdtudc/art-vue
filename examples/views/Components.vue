<template>
  <div class="art-site-components">
    <div class="art-site-components-header">
      <header class="clearfix">
        <a class="art-site-components-header-logo" href="/">
          <img src="static/logo.png" alt="logo">
        </a>
        <div class="art-site-components-header-menu">
      ...
      <div class="art-site-components-header-endnote">
        <span v-text="endnote"></span>
      </div>
    </div>
    <div class="art-site-components-wrap">
      <transition name="fade-in">
        <div class="art-site-components-nav" v-if="endnote" :class="[needFixed && 'art-site-components-nav_fixed']" :style="styles">
      ...
      <div class="art-site-components-cont">
        <div class="art-markdown" :class="mdClass">
	...
	export default {
		data() {
			return {
				menuData: [
					{name: "组件", active: true},
					{name: "设计语言", path: "/design/concept", active: false}
				],
				navData: config.componentData,
				curNav: null,
				endnote: null,
				needFixed: false,
				styles: null,
		...
		computed: {
			mdClass() {
				...
				if (path === "/components/summary" || path === "/components/changelog") {
					return "art-wiki"
				} else {
					return ""
				}
